[Setup]
; App ID must be unique for each application
...
Source: "Elvar\Elvar.exe"; DestDir: "{app}"; Flags: ignoreversion
; Copy the _internal folder and all its contents
Source: "Elvar\_internal\*"; DestDir: "{app}\_internal"; Flags: ignoreversion recursesubdirs createallsubdirs
; Copy the icon
Source: "elvar_icon.ico"; DestDir: "{app}"; Flags: ignoreversion
